...
public class CustomTextInputFormat extends Configured implements Tool {
...
//						String result = resultMap.get("reveiwId") + "," + resultMap.get("createDate") + "," +resultMap.get("addLocs") + "," + resultMap.get("delLocs") + "," + resultMap.get("modLocs") + ",";
	...
	public int run(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(CustomTextInputFormat.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new CustomTextInputFormat(), args);
		System.exit(res);
	}
